<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['section:section:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['section:section:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['section:section:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['section:section:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="sectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="显示/隐藏" align="center" prop="isHidden">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['section:section:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="60%" append-to-body>
      <el-form ref="sectionRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="名称" prop="name">
...
function getList() {
  ...
  listSection(queryParams.value).then(response => {
    sectionList.value = response.rows
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除栏目编号为"' + _ids + '"的数据项？').then(function() {
    return delSection(_ids)
  }).then(() => {
    getList()
...
function handleExport() {
  proxy.download('section/section/export', {
    ...queryParams.value
